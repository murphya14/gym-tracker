...
//   useEffect(() => {
//     void router.replace("/admin/workouts");
//   }, [router]);
...
//export default Home;
// Commented out as gredirecting straight to /admin/workouts for now, but keeping this as a placeholder for a more fleshed out home page in the future
